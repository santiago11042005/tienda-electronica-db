...
# Sistema de Gestión de Base de Datos: E-Commerce
**Estudiante:** Santiago Briseño Granados  
**Formato del Informe:** LaTeX (PDF incluido en el repositorio)

## Script Oficial de la Base de Datos 
